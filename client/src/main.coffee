...
daemons = new Daemons [
	...
	{"daemon_id": "234", "daemon_name": "bar", "daemon_state": "STOPPED", "daemon_address": "ws://127.0.0.1:8080/ws", "daemon_port": "777", "daemon_platform": {"OS": "Linux", "Architecture": "32 bit"}, "daemon_all_parameters": ["CPU", "RAM", "HDD"], "daemon_monitored_parameters": ["CPU", "RAM"]},
	{"daemon_id": "345", "daemon_name": "foobar", "daemon_state": "NOT_KNOWN", "daemon_address": "ws://127.0.0.1:8080/ws", "daemon_port": "111", "daemon_platform": {"OS": "Linux", "Architecture": "128 bit"}, "daemon_all_parameters": ["CPU", "RAM", "HDD"], "daemon_monitored_parameters": ["CPU", "HDD"]},
	{"daemon_id": "456", "daemon_name": "Bob", "daemon_state": "EATING A PIZZA", "daemon_address": "ws://127.0.0.1:8080/ws", "daemon_port": "222", "daemon_platform": {"OS": "Windows 7", "Architecture": "16 bit"}, "daemon_all_parameters": ["CPU", "RAM", "HDD"], "daemon_monitored_parameters": ["HDD"]},
]

...
createDaemons = function(data) {
  var daemon, _i, _len, _results;
  daemons = [];
  _results = [];
  for (_i = 0, _len = data.length; _i < _len; _i++) {
    daemon = data[_i];
    _results.push(daemons.push(new Daemon(data)));
  }
  return _results;
};

...
var Daemon, Graph, SmoothRandomGenerator, checkData, controlStatus, cookieExpiryDays, createDaemonWebSocket, createMessage, createServerWebSocket, daemons, daemonws, development, error, getCookie, getDaemon, getGraph, graph_id, graphs, init, initUI, isUserLoggedIn, loginCheckSuccessful, loginCheckUnsuccessful, loginSuccessful, loginUnsuccessful, logoutError, logoutSuccessful, messages, monitoringData, notImplemented, processControl, processDaemons, processError, processIncomingMessage, processLogin, processLoginCheck, processLogout, processMonitoring, processNotImplemented, reconnectTimerDaemon, reconnectTimerServer, reconnectTiming, sendControl, sendDaemons, sendLogin, sendLoginCheck, sendLogout, serverAddress, serverws, setCookie, simulate, test, testIN, testOUT, testing, trySendMessage, updateDaemons, wsDaemonOnCloseHandler, wsDaemonOnErrorHandler, wsDaemonOnMessageHandler, wsDaemonOnOpenHandler, wsServerOnCloseHandler, wsServerOnErrorHandler, wsServerOnMessageHandler, wsServerOnOpenHandler,

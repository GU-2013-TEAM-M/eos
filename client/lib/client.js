  ...
  return setInterval(function() {
    ...
    karmaMessage = {
      ...
      data: {
        ...
        "data": {
          "karma": Math.floor((Math.random() * 100) + 1),
          "cpu": [Math.floor((Math.random() * 100) + 1), Math.floor((Math.random() * 100) + 1), Math.floor((Math.random() * 100) + 1), Math.floor((Math.random() * 100) + 1)],
          "ram": Math.floor((Math.random() * 2048) + 1)
        }
      }
    };

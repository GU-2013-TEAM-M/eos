...
AlertsTabLayout = Backbone.Marionette.Layout.extend({
  ...
  onRender: function() {
    this.daemonList.show(views.daemonsView);
    this.alertList.show(views.alertTriggersView);
    return this.instanceList.show(views.alertsView);
  }
});
...
AlertTriggersView = Backbone.Marionette.CompositeView.extend({
  ...
  itemViewContainer: "ul",
  onBeforeRender: function() {
    this.model = appState.get("current_alert_trigger");
    if (!this.model) {
      this.model = alerts.models[0];
      return appState.set("current_alert_trigger", this.model);
      /*
...
MyApp.addInitializer(function(options) {
  ...
  return views = {
    ...
    alertTriggersView: new AlertTriggersView({
